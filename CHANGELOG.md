...
#### [0.17.0](https://github.com/gfargo/git-hash-art/compare/0.16.1...0.17.0)

- feat: express colour operations in OKLCH [`#35`](https://github.com/gfargo/git-hash-art/pull/35)
- feat: aspect-native placement — compositions fill the frame they're given [`#34`](https://github.com/gfargo/git-hash-art/pull/34)

#### [0.16.1](https://github.com/gfargo/git-hash-art/compare/0.16.0...0.16.1)

> 2 August 2026

- fix(ci): unblock the www deploy — pnpm major, repo name, Node, PAT preflight [`#33`](https://github.com/gfargo/git-hash-art/pull/33)
- chore: release v0.16.1 [`a5aba27`](https://github.com/gfargo/git-hash-art/commit/a5aba27be2cac25e2ea8fd0f2301981ca6b1f2ce)

#### [0.16.0](https://github.com/gfargo/git-hash-art/compare/0.15.0...0.16.0)

> 2 August 2026

- feat: corpus evaluation harness [`#32`](https://github.com/gfargo/git-hash-art/pull/32)
- fix: wrapper entry points suppressed every archetype override [`#31`](https://github.com/gfargo/git-hash-art/pull/31)
- feat: attractor substrates — emergent structure under the shape layers [`#30`](https://github.com/gfargo/git-hash-art/pull/30)
- feat: shape selection weights; cull the clip-art vocabulary [`#29`](https://github.com/gfargo/git-hash-art/pull/29)
- fix: repair background-luminance contract; add colour zoning and scale hierarchy [`#27`](https://github.com/gfargo/git-hash-art/pull/27)
- docs: OSS-grade README with badges, live gallery, and v0.15 features [`#26`](https://github.com/gfargo/git-hash-art/pull/26)
- docs: OSS-grade README with badges, live gallery grid, and v0.15 features [`e327882`](https://github.com/gfargo/git-hash-art/commit/e327882c3034a1a38b05b4eceffa0ec8414fc8d4)
- chore: release v0.16.0 [`6a34015`](https://github.com/gfargo/git-hash-art/commit/6a34015ea0bc24e48661ca8f9e0848c802d8f116)
- Ignore .www and add Node version [`4939d8b`](https://github.com/gfargo/git-hash-art/commit/4939d8bcdeaa8951cd3bfd04d4cb5702ffb943c2)

#### [0.15.0](https://github.com/gfargo/git-hash-art/compare/0.14.0...0.15.0)

> 22 July 2026

- feat: artistic overhaul — composition, color discipline & generative mark-making [`#25`](https://github.com/gfargo/git-hash-art/pull/25)
- feat: artistic overhaul — composition, color discipline, and generative mark-making [`0dc917b`](https://github.com/gfargo/git-hash-art/commit/0dc917b7a78ee739e0e5dff8a67dcaecb9936be2)
- fix: review refinements — symmetry ghost bug, dedupe, rarer mirroring [`133ff22`](https://github.com/gfargo/git-hash-art/commit/133ff22a65cb6b05eae8cd661b7fd9a539664604)
- chore: release v0.15.0 [`4d4fbaf`](https://github.com/gfargo/git-hash-art/commit/4d4fbafcea48713814c6bd0a5cf47ab6adb84315)
...
- chore: release v0.14.0 [`04b880f`](https://github.com/gfargo/git-hash-art/commit/04b880f19c3d4cb6f10dfb85b4f580caa1a290b5)
